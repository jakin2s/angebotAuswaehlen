...
public class Akzeptanztest {
    ...
    public void es_gibt_kein_angebot() {
        Mockito.when(mockExternalTask.getVariable("AngebotsListe")).thenReturn(new ArrayList<Angebot>());
    }
    ...
    public void esGibtDieFolgendenAngebote(DataTable dataTable) {
        ...
        Mockito.when(mockExternalTask.getVariable("AngebotsListe")).thenReturn(angebotList);
    ...
    public void istDiesesDasBesteAngebot(DataTable dataTable) {
        ...
        assertThat(args.containsKey("bestesAngebot"), equalTo(true));

        assertThat(((Angebot) args.get("bestesAngebot")).getId(), equalTo(angebot.getId()));
        assertThat(((Angebot) args.get("bestesAngebot")).getEinzelpreis(), equalTo(angebot.getEinzelpreis()));
        assertThat(((Angebot) args.get("bestesAngebot")).getGesamtpreis(), equalTo(angebot.getGesamtpreis()));
